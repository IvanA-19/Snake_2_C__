...
Актуальную версию игры можно скачать по ссылке: https://disk.yandex.ru/d/ng6lBLLJTmS5uA

Данная версия оптимизирована для компьютеров с различным разрешением экрана: с низким необходимо при запуске выбрать Low grphics, а с высоким - High graphics, после чего нажать enter для запуска игры
